  ...
  return (
    <Layout>
      <DefaultHead
        ...
        type={"website"}
        date={"2024-08-07"}
        excerpt={`Hi, my name is Dan and I'm a CS Major interested in all things software development. I am currently working towards a BS in Computer Science at the University of New Hampshire and in my free time I like to work on different projects often in Python or Javascript.`}
